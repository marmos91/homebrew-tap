...
cask "dfs-pro" do
  ...
  on_macos do
    on_intel do
      url "https://github.com/marmos91/dittofs-pro/releases/download/v#{version}/dfs_#{version}_darwin_amd64.tar.gz"
      sha256 "6e386c7969e20a013cd83f084bff9c60df55314c920773a8839200907965be89"
    end
    on_arm do
      url "https://github.com/marmos91/dittofs-pro/releases/download/v#{version}/dfs_#{version}_darwin_arm64.tar.gz"
  ...
  on_linux do
    on_intel do
      url "https://github.com/marmos91/dittofs-pro/releases/download/v#{version}/dfs_#{version}_linux_amd64.tar.gz"
      sha256 "22eae91d2e6f335bfa5388389675ba1d57a1042ffcfcd732e6bbcc81947bfdf9"
    end
    on_arm do
      url "https://github.com/marmos91/dittofs-pro/releases/download/v#{version}/dfs_#{version}_linux_arm64.tar.gz"
